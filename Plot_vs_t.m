...
for i = 1:size(nk,1)
    n = nk(i,1);
    k = nk(i,2);
    [SESD,~,~,~,~] = SESD_NESR_QBER('t',t,'n',n,'k',k,'P',P,'p1',p1);
...
for i = 1:size(nk,1)
    n = nk(i,1);
    k = nk(i,2);
    [~,NESR,~,~,~] = SESD_NESR_QBER('t',t,'n',n,'k',k,'P',P,'p1',p1);
...
for i = 1:size(nk,1)
    n = nk(i,1);
    k = nk(i,2);
    [~,~,QBER,~,~] = SESD_NESR_QBER('t',t,'n',n,'k',k,'P',P,'p1',p1);
